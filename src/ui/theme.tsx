...
export const theme = {
  ...
  textColor,
  hintColor,
  hintColorComputed: hintColor,
  linkColor,
  buttonColor,
  buttonTextColor,
  secondaryBgColor,

  buttonColorComputed: buttonColor,
  buttonColorLighter: colord(buttonColor).lighten(0.4).toHex(),
  buttonTextColorComputed: buttonTextColor,
