...
export const Link: FC<LinkProps> = ({
  ...
  return isTApp ?
    <TGLink className={className} onClick={propsOnClick} href={href} {...rest} /> :
    <WebLink className={className} onClick={propsOnClick} href={href} {...rest} />
};

const WebLink: FC<LinkProps> = ({
  className,
  onClick: propsOnClick,
  href,
  ...rest
